...
namespace AdvancedPlatformer
{
    public class Program
    {
        ...
        {
            can = new GLCanvas(width: 1200, height: 800, BackColor: new Color(66, 223, 244));
            loadLevel();
        ...
        public static void loadLevel()
        {
            ...
            TileMap tilemap = new TileMap(workFile);
            ...
            for (int l = 0; l < tilemap.layers; l++)
                foreach (TileMap.Tile t in tilemap.OpSprites[l])
    ...
    {
        vec2 Scale = new vec2(Program.tileScale * 2);
        public override void Start()
        {
    ...
    {
        vec2 Scale = new vec2(Program.tileScale * 0.5f);
        public override void Start()
        {
    ...
    public class Texture : GameObject
    {
        ...
        {
            DrawIndex = index;
            AddChildShape(new Sprite(path, vec2.Zero, scale, uvScale: scale / Program.tileScale));
        }
    }
}
