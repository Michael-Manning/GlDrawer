...
namespace GLDrawer
{
    ...
    public partial class GLCanvas
    {
        ...
        {
            return gldw.Input.getKey((int)button);
        }
        /// <summary>
        ...
        {
            return gldw.Input.getKeyDown((int)button);
        }
        /// <summary>
        ...
        vec2 lastLeftClick { get { return iLastLeft; } }
        ...
        vec2 lastRightClick { get { return iLastLeft; } }
